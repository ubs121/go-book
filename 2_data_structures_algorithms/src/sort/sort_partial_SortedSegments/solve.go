...
import (
	"bufio"
	"fmt"
	srt "gobook/2_data_structures_algorithms/src/sort"
	"os"
	"sort"
	"strings"
)
...
func main() {
	...
	for i := 0; i < q; i++ {
		...
		if curr.l < next.l {
			srt.PartialSortLeft(a, curr.l, curr.r, next.l)
		} else {
			srt.PartialSortRight(a, curr.l, curr.r, next.r)
		}
	}

	// last query
	srt.PartialSortLeft(a, chain[q].l, chain[q].r, k)
