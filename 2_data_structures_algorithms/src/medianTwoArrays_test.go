...
func TestSolve(t *testing.T) {
	testCases := []struct {
		...
		{[]int{2}, []int{}, 2.0},
		{[]int{}, []int{1, 2, 3, 4}, 2.5},
		{[]int{1, 3, 3, 4, 4}, []int{1, 1, 2, 2, 3}, 2.5},
		{[]int{1}, []int{1, 2, 2, 2, 2, 3, 4}, 2.0},
		{[]int{0, 0, 0, 0, 0}, []int{-1, 0, 0, 0, 0, 0, 1}, 0.0},
		{[]int{1, 3}, []int{2, 7}, 2.5},
		{[]int{2, 3, 4}, []int{1}, 2.5},
		{[]int{5, 6}, []int{1, 2, 3, 4, 7, 8, 9}, 5.0},
		{[]int{1, 2}, []int{-1, 3}, 1.5},
		{[]int{1, 4}, []int{2, 3, 5, 6, 7, 8}, 4.5},
		{[]int{1, 3, 5}, []int{2, 4, 6, 7, 8}, 4.5},
		{[]int{5, 6, 7}, []int{1, 2, 3, 4, 8, 9, 10}, 5.5},
		{[]int{1, 2, 2}, []int{1, 2, 3}, 2.0},
		{[]int{1, 2, 3}, []int{1, 2, 2}, 2.0},
	}

	for i, tc := range testCases {
		got := findMedianSortedArrays(tc.a, tc.b)
		if got != tc.exp {
			t.Errorf("tc %d: exp %f, got %f", i, tc.exp, got)
		}
	}
}
