...
Массив бол ижил төрлийн, тодорхой урттай, дугаартай өгөгдлийн дараалал юм. Санах ойд энэ бүтэц нь үргэлжилсэн хайрцгууд болж байрладаг. Нэг хайрцгийг нь элемент гэж нэрлэнэ. Элементийн тоог массивын хэмжээ эсвэл урт гэнэ.
...
Дээрх жишээнд 3 элемент бүхий `arr` массив үүсгэсэн байна. Массивын нэг элементэд хандахдаа нэрнийх нь ард тухайн элементийн дугаарыг дөрвөлжин хаалтад `[ ]` бичиж заана. Массивын дугаарлалтыг `0`-ээс эхэлдэг. Тиймээс дээрх гурван элемент `arr[0]`, `arr[1]`, `arr[2]` гэж дугаарлагдана, мөн тусдаа хувьсагчид гэж төсөөлж болно.
